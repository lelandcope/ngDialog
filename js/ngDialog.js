                    ...
                    open: function (opts) {
                        ...
                        $q.when(loadTemplate(options.template || options.templateUrl)).then(function (template) {
                            ...
                            if (typeof $window.Hammer !== 'undefined') {
                                ...
                                var moveHandler, removeTapHandler, tapHandler, touchStartHandler;
                                var tapTarget, tapStartX, tapStartY;
                                var tapDistanceThreshold = 25;
                                var tapTimeThreshold = 500;
                                var tapped = false;
                                ...
                                moveHandler = function(moveEvent) {
                                    ...
                                    if (Math.abs(moveX - tapStartX) > tapDistanceThreshold || Math.abs(moveY - tapStartY) > tapDistanceThreshold) {
                                        tapped = true;
                                ...
                                touchStartHandler = function(startEvent) {
                                    ...
                                    $timeout(removeTapHandler, tapTimeThreshold);

                                    $dialog.on('touchmove', moveHandler);
                                    $dialog.on('touchend', tapHandler);
                                };

                                $dialog.on('touchstart', touchStartHandler);
